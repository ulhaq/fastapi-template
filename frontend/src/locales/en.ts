export default {
  ...
  nav: {
    ...
    logOut: "Log out",
    pages: "Pages",
    failedToSwitchTenant: "Failed to switch organization",
    billing: "Billing",
  },
  common: {
    cancel: "Cancel",
  ...
  billing: {
    ...
    startTrialPlan: "You're on the {plan} plan",
    startTrialDays: "{days}-day free trial",
    startTrialThen: "then {price} / {interval}",
    startTrialButton: "Start free trial",
    noCardRequired: "No credit card required",
    trialEndsOn: "Your free trial ends on {date}. Add a payment method to avoid interruption.",
    ...
    cancelScheduledSuccess: "Subscription will be cancelled at end of billing period",
    ...
    checkoutPendingDescription: "This may take a moment. Check your billing page shortly.",
    ...
    banner: {
      ...
      trialEndingTomorrow: "Your free trial ends tomorrow.",
