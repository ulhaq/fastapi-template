...
export default {
  ...
  roles: {
    ...
    form: {
      ...
      assignedPermissionsSuccess: '{number} permissions have been assigned to the role',
      unassignedPermissionsSuccess: 'All permissions have been removed from the role',
    },
    permissionForm: {
