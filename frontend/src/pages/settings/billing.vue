      ...
      <div class="rounded-lg border p-6 space-y-4">
        ...
        <div v-if="subscription.status === 'trialing' && subscription.trial_end">
          ...
          <div
            ...
            class="rounded-md border border-amber-200 bg-amber-50 px-4 py-3 flex items-start justify-between gap-4"
          >
            ...
            <PermissionGuard permission="manage:subscription">
              <button
                class="text-sm font-medium text-amber-900 underline whitespace-nowrap"
